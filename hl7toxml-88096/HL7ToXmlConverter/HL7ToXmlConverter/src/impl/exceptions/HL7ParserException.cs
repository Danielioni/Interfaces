...
namespace Janoman.Healthcare.HL7
{
    ...
    /// </summary>
    [Serializable]
    public class HL7ParserException : HL7ToXmlConverterException
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        public HL7ParserException() : base()
        {
        }
        ...
        public HL7ParserException(string message, Exception e)
            : base(message, e)
        {
        }
    }
